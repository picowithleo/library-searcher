        ...
        <section>
            <div class="lib-res-left">
                <div class="lib-category">
                        ...
                        <figure>
                        <img src="image/lia_a.jpg" alt="Library d"></a>
                        </figure>
                        ...
                        <?php
                            ...
                            $sql = "SELECT library_name, address, locality, postcode, phone, wifi, email, opening_hours_monday, opening_hours_tuesday, opening_hours_wednesday, opening_hours_thursday, opening_hours_friday, opening_hours_saturday, opening_hours_sunday, date_created, date_last_updated FROM library WHERE library_name = 'Badu Island Indigenous Knowledge Centre'";
