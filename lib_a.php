            ...
            <div class="lib-res-left">
                <div class="lib-category">
                        ...
                        <?php
                            ...
                            $sql = "SELECT library_name, address, locality, postcode, phone, wifi, email, opening_hours_monday, opening_hours_tuesday, opening_hours_wednesday, opening_hours_thursday, opening_hours_friday, opening_hours_saturday, opening_hours_sunday, date_created, date_last_updated FROM library WHERE library_name = 'Zillmere Library'";
